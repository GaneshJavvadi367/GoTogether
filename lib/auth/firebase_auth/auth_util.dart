...
DocumentReference? get currentUserReference =>
    loggedIn ? LogindetailsRecord.collection.doc(currentUser!.uid) : null;

LogindetailsRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : LogindetailsRecord.getDocument(
                  LogindetailsRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
